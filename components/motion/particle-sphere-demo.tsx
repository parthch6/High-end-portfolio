  ...
  return (
    <div className="w-full min-h-screen bg-black">
      ...
      <div className="w-full h-screen">
        {version === 'standard' ? <ParticleSphere /> : <OptimizedParticleSphere />}
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-6 pointer-events-none">
        <div className="max-w-2xl mx-auto text-gray-400 text-sm">
          <p className="mb-2">
            Version: {version === 'optimized' ? 'GPU-optimized with shaders' : 'Standard Three.js Points'}
          </p>
          <p>Move your mouse to rotate the particle sphere.</p>
